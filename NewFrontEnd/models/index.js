...
if (config.use_env_variable) {
  ...
  var sequelize = new Sequelize(process.env[config.database], process.env[config.username], process.env[config.password], config); //config is only looking at dialect and host
}
